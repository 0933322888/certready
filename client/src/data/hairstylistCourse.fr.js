...
export const hairstylistCourse = {
  ...
  trade: 'Coiffeur',
  tradeCode: '332A',
  description: 'Préparez-vous à l’examen Sceau rouge de coiffeur avec des contenus d’étude ciblés, un glossaire utile et un examen blanc adapté au métier 332A.',
  seoTitle: 'Préparation à l’examen Sceau rouge de coiffeur — guide d’étude 332A',
  seoDescription: 'Maîtrisez l’examen Sceau rouge de coiffeur avec des modules d’étude détaillés, des questions pratiques et une préparation complète pour le métier 332A.',
  seoKeywords: 'coiffeur, 332A, examen Sceau rouge, guide d’étude, questions pratiques, certification métier Ontario',
  frSeoTitle: 'Préparation à l’examen Sceau rouge de coiffeur — guide d’étude 332A',
  frSeoDescription: 'Maîtrisez l’examen Sceau rouge de coiffeur avec des modules d’étude détaillés, des questions pratiques et une préparation complète pour le métier 332A.',
  frSeoKeywords: 'coiffeur, 332A, examen Sceau rouge, guide d’étude, questions pratiques, certification métier Ontario',
