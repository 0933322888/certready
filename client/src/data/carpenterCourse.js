...
const carpenterCourse = {
    meta: {
        ...
        seoKeywords: 'Carpenter, 403A, 403A practice exam, Carpenter Red Seal exam, 403A exam prep, Carpentry Red Seal practice test, Carpentry certification Canada, Carpenter apprenticeship exam, Carpentry study guide, Carpentry practice questions, Carpenter mock exam, Red Seal carpenter exam, Red Seal exam preparation, Red Seal practice exam, Red Seal practice questions, Red Seal certification, Canada trade certification, Trade exam prep, Apprenticeship exam preparation, Red Seal study guide, Red Seal mock exam, Pass your Red Seal exam',
        ogImage: '/course-images/og/carpenter.png',
    ...
    parts: [
        ...
        // ============================================================
        {
            ...
            description: 'Doors, windows, roofing, and cladding — the envelope that protects the building from weather. MWA E carries 14 questions across three tasks: E-14 (41%), E-15 (24%), and E-16 (35%).',
            chapters: [

                // CHAPTER 11 — EXTERIOR DOORS, WINDOWS, AND ROOFING (MWA E-14, E-15)
                {
                    id: 'ch-11',
                    number: 11,
                    title: 'Exterior Doors, Windows, and Roofing',
                    subtitle: 'MWA E-14 · Installs Exterior Doors and Windows (41%) & E-15 · Installs Roofing (24%)',
                    isFree: false,
                    estimatedMinutes: 60,
                    sections: [
                        {
                            id: 'ch11-s1',
                            title: '11.1 Exterior Door and Window Installation',
                            content: [
                                {
                                    type: 'paragraph',
                                    text: 'Exterior doors and windows must be installed so they are plumb, level, square, and properly flashed. A poorly installed unit allows air and water infiltration, causes premature rot and mould, and fails to operate correctly. The flashing sequence is the most exam-critical aspect of this task — water must always be directed out and away from the building envelope.',
                                },
                                {
                                    type: 'keyTerm',
                                    term: 'Rough Opening (RO)',
                                    definition: 'The framed opening that receives a door or window unit. The RO is larger than the unit to allow for shimming and levelling. Typical RO: unit width + 50 mm, unit height + 50–75 mm. Always confirm from the door/window schedule or manufacturer\'s rough opening specification.',
                                },
                                {
                                    type: 'table',
                                    headers: ['Component / Step', 'Key Requirements'],
                                    rows: [
                                        ['Sill pan flashing', 'Installed first, before the unit; directs water that penetrates behind the unit outward and away from the framing; sloped minimum 1:50 to the exterior; self-adhering membrane or pre-formed metal pan; the most critical step — omitting it leads to rot at the RO sill'],
                                        ['Jamb / frame installation', 'Set unit plumb, level, and square in the RO; check diagonal measurements are equal; shim at hinge locations and lock side; never rely on a single shim — always use opposing shims to avoid racking the frame'],
                                        ['Fastening', 'Nail or screw through the nailing fin (if present) or through the jamb with appropriate fastener spacing per manufacturer spec; confirm fasteners do not prevent operation of the unit'],
                                        ['Flashing sequence at jambs', 'Self-adhering membrane tape applied up the sides over the nailing fin; laps over the sill pan flashing at the bottom; lapped under the head flashing above — always shingle-lap (upper over lower)'],
                                        ['Head flashing', 'Metal drip cap or self-adhering membrane over the top of the unit; tucks under the housewrap above the unit and laps over the nailing fin; shed water out over the top of the unit'],
                                        ['Reveals and margins', 'Consistent margin (reveal) between the door/window unit and the finish frame on all four sides; typically 3–4 mm; inconsistent reveals indicate the unit is not square in the RO'],
                                        ['Door hanging', 'Hinge mortises cut to flush depth; hinge screws engage the framing stud (not just the jamb) for structural support; door must swing without binding; adjust strike plate so latch engages smoothly; door gap at bottom = 6–10 mm clearance above threshold or flooring'],
                                        ['Exterior door hardware', 'Locksets, deadbolts, closers, and thresholds installed per manufacturer\'s template; threshold height adjusted for floor finish thickness; weatherstripping in full contact on all four sides when door is closed'],
                                    ],
                                },
                                {
                                    type: 'infoBox',
                                    title: 'Flashing Rule — Always Shingle Lap (Upper Over Lower)',
                                    items: [
                                        'Sill pan flashing goes in FIRST — before the unit is set',
                                        'Jamb tape goes on SECOND — lapped over the sill pan at the bottom',
                                        'Head flashing goes on LAST — lapped over the jamb tape at the top',
                                        'Housewrap always laps over any flashing that exits the wall — never tucked under',
                                        'Any reversal of this sequence creates a back-lap that channels water INTO the wall',
                                        'This sequence applies equally to windows, exterior doors, and any wall penetration',
                                    ],
                                },
                            ],
                        },
                        {
                            id: 'ch11-s2',
                            title: '11.2 Roofing Components and Installation',
                            content: [
                                {
                                    type: 'paragraph',
                                    text: 'Roofing is a multi-layer system where each component has a specific function and a specific installation sequence. Understanding the layers and the sequence — from the structural deck up to the ridge cap — is the core of Task E-15.',
                                },
                                {
                                    type: 'table',
                                    headers: ['Roofing Layer / Component', 'Function and Key Requirements'],
                                    rows: [
                                        ['Roof sheathing (deck)', 'OSB or plywood nailed to rafters or truss top chords; minimum 9.5 mm for 400 mm o.c., 11 mm for 600 mm o.c.; H-clips between panels at unsupported edges; stagger panel joints; leave 3 mm gap between panels for expansion'],
                                        ['Drip edge (eave)', 'Metal flashing installed along the eave before the underlayment; directs water off the edge into the gutter; goes UNDER the underlayment at the eave'],
                                        ['Ice and water shield', 'Self-adhering rubberized asphalt membrane at eaves and valleys; required minimum 900 mm (1 m) past the interior wall line in cold climates; adheres directly to the deck and self-seals around fasteners; provides protection against ice dams'],
                                        ['Roofing underlayment (felt or synthetic)', 'Secondary water barrier over the full deck; applied horizontally starting at the eave; lapped minimum 100 mm at horizontal joints, 150 mm at vertical joints; at rakes, drip edge goes OVER the underlayment'],
                                        ['Drip edge (rake)', 'Metal flashing along the rake (gable) edge; installed OVER the underlayment at the rake — opposite to the eave'],
                                        ['Valley flashing', 'Open metal valley: W-metal or V-metal laid in the valley over ice-and-water shield; shingles cut back minimum 100 mm from the centreline; closed-cut valley: shingles from one side extend across, shingles from the other side are cut on the valley line'],
                                        ['Step flashing', 'Individual L-shaped metal pieces installed at every course where a roof meets a vertical wall or chimney; each piece is woven between shingle courses; counter-flashing covers the top of the step flashing from above'],
                                        ['Asphalt shingles', 'Installed starting at the eave with a starter course (shingles installed upside-down or purpose-made starter strip); full courses above with 5–6 mm side lap and manufacturer-specified exposure; nails 25 mm above the cutout, 4 nails minimum per shingle, 6 nails in high-wind zones'],
                                        ['Ridge cap', 'Purpose-made hip and ridge shingles or cut standard shingles; covers the ridge and hip lines; nails covered by each successive piece; installed in the direction of the prevailing wind (lapped away from wind)'],
                                    ],
                                },
                                {
                                    type: 'keyTerm',
                                    term: 'Ice Dam',
                                    definition: 'A ridge of ice that forms at the eave of a roof when heat escaping from the building melts snow on the upper roof; meltwater runs down and refreezes at the cold eave overhang, backing up under shingles and causing water infiltration. Prevented by adequate attic insulation, ventilation, and ice-and-water shield membrane at the eave.',
                                },
                                {
                                    type: 'infoBox',
                                    title: 'Roofing Layer Sequence (Bottom to Top)',
                                    items: [
                                        '1. Sheathing (structural deck)',
                                        '2. Drip edge at EAVE — goes UNDER underlayment',
                                        '3. Ice and water shield at eaves and valleys',
                                        '4. Underlayment over full deck',
                                        '5. Drip edge at RAKE — goes OVER underlayment',
                                        '6. Valley flashing',
                                        '7. Step flashing at walls and chimneys (woven with shingle courses)',
                                        '8. Starter course of shingles at eave',
                                        '9. Shingle courses up the slope',
                                        '10. Ridge cap at peak',
                                    ],
                                },
                            ],
                        },
                ...
                // CHAPTER 12 — EXTERIOR FINISHES AND CLADDING (MWA E-16)
                {
                    id: 'ch-12',
                    number: 12,
                    title: 'Exterior Finishes and Cladding',
                    subtitle: 'MWA E-16 · Installs Exterior Finishes (35% of MWA E — 5 questions)',
                    isFree: false,
                    estimatedMinutes: 45,
                    sections: [
                        {
                            id: 'ch12-s1',
                            title: '12.1 Exterior Wall Components',
                            content: [
                                {
                                    type: 'paragraph',
                                    text: 'Before cladding is installed, the wall assembly must include all required components in the correct sequence. The wall assembly from inside to outside is: structure → insulation → sheathing → air/vapour barrier (if applicable) → housewrap → drainage plane (rain screen if required) → cladding.',
                                },
                                {
                                    type: 'table',
                                    headers: ['Component', 'Function and Key Notes'],
                                    rows: [
                                        ['Structural sheathing (OSB/plywood)', 'Provides racking resistance; nailing schedule critical for shear wall performance; joints must land on framing members'],
                                        ['Housewrap (building membrane)', 'Secondary air and water-resistive barrier behind cladding; lapped shingle-fashion; taped at seams; all penetrations sealed; must breathe (vapour-open) to allow drying to the exterior'],
                                        ['Strapping / furring strips (rain screen)', '19–38 mm vertical wood or metal strips over housewrap creating a drained and ventilated cavity behind cladding; required in high-rainfall climates; allows cladding to drain and dry; open at bottom with insect screen, vented at top'],
                                        ['Corner trim and starter strips', 'Establish the baseline and corners for cladding alignment; installed plumb and level before any cladding panels or boards begin; all exposed end grain protected with flashing or sealant'],
                                        ['Window and door trim (exterior casing)', 'Installed after windows and doors are flashed; provides finished edge and additional weather protection; back-primed before installation; sealant joint between trim and cladding — not between trim and window unit (allows drainage)'],
                                    ],
                                },
                            ],
                        },
                        {
                            id: 'ch12-s2',
                            title: '12.2 Exterior Cladding Types',
                            content: [
                                {
                                    type: 'paragraph',
                                    text: 'Carpenters install a wide range of exterior cladding materials. Each has specific installation requirements for fastening, spacing, overlap, and clearances that must be followed to maintain manufacturer warranties and code compliance.',
                                },
                                {
                                    type: 'table',
                                    headers: ['Cladding Type', 'Key Installation Requirements'],
                                    rows: [
                                        ['Vinyl siding', 'Nail in the centre of the nail slot — never nail tight; leave 1 mm clearance under nail head to allow thermal movement; overlap panels minimum 25 mm at vertical joints; stagger joints between courses; bottom course requires starter strip; panels must be free to move horizontally'],
                                        ['Fibre cement siding (James Hardie type)', 'Very heavy — requires two people or a panel carrier; pre-primed or pre-finished; fastener penetration into framing minimum 32 mm; keep bottom edge minimum 50 mm above grade and 25 mm above roofing; cut with fibre cement shears, score-and-snap, or carbide blade — always wear P100 respirator (silica); all cut ends must be field-painted before installation'],
                                        ['Wood lap siding (bevel siding)', 'Minimum 25 mm overlap between courses; one nail per stud per course — never nail through the overlap of the course below (prevents movement and causes splitting); back-prime all surfaces before installation; maintain minimum 200 mm clearance above grade'],
                                        ['Wood shakes and shingles', 'Double starter course at the bottom; exposure = (shingle length − 25 mm) ÷ 2 maximum; stagger vertical joints minimum 38 mm between courses; leave 6 mm gap between shingles for expansion; corrosion-resistant fasteners only'],
                                        ['Stucco (three-coat system)', 'Metal lath fastened to sheathing; scratch coat (base), brown coat (levelling), finish coat; each coat must cure before the next; control joints required to limit cracking; one-coat stucco systems common in modern construction'],
                                        ['Brick veneer', 'Carpenters install the wood framing, sheathing, and housewrap substrate; masons lay the brick; carpenters install metal wall ties (brick ties) into the stud framing at specified spacing to anchor the veneer; 25–50 mm air space maintained between brick and housewrap; weep holes at base course every 600 mm to drain cavity'],
                                    ],
                                },
                                {
                                    type: 'infoBox',
                                    title: 'Common Cladding Installation Errors (Frequently Tested)',
                                    items: [
                                        'Vinyl siding nailed tight — thermal expansion has nowhere to go; panels buckle in summer',
                                        'Fibre cement cut ends not field-painted — moisture enters the cut; swelling and delamination result',
                                        'Wood siding nailed through the overlap — splits shingles and traps moisture; must nail above the overlap of the course below',
                                        'Missing or reversed housewrap laps — water directed into the wall instead of out',
                                        'Cladding too close to grade or roofing — capillary absorption causes rot at the base',
                                        'Missing weep holes in brick veneer — cavity fills with water; ties corrode and veneer fails',
                                        'Skipping the rain screen cavity in high-rainfall zones — cladding stays wet; mould and rot behind the wall assembly',
                                    ],
                                },
                            ],
                        },
        ...
        // ============================================================
        {
            ...
            description: 'Wall and ceiling finishes, flooring, interior doors and windows, stairs and finish components — the work that defines the quality of the final product. MWA F carries 14 questions across four tasks: F-17 (17%), F-18 (17%), F-19 (31%), F-20 (35%).',
            chapters: [

                // CHAPTER 13 — WALL, CEILING FINISHES AND FLOORING (MWA F-17, F-18)
                {
                    id: 'ch-13',
                    number: 13,
                    title: 'Wall, Ceiling Finishes and Flooring',
                    subtitle: 'MWA F-17 · Applies Wall and Ceiling Finishes (17%) & F-18 · Installs Flooring (17%)',
                    isFree: false,
                    estimatedMinutes: 55,
                    sections: [
                        {
                            id: 'ch13-s1',
                            title: '13.1 Drywall Installation',
                            content: [
                                {
                                    type: 'paragraph',
                                    text: 'Drywall (gypsum wallboard) is the dominant wall and ceiling finish in Canadian construction. Selecting the correct drywall type for the application, installing it in the correct sequence, and following the fastening schedule are all exam topics — particularly for fire-rated assemblies.',
                                },
                                {
                                    type: 'table',
                                    headers: ['Drywall Type', 'Application', 'Key Identifier'],
                                    rows: [
                                        ['Regular (standard)', 'Interior walls and ceilings in dry, non-fire-rated locations', 'White paper face; grey paper back'],
                                        ['Type X (fire-rated)', 'Fire-rated wall and ceiling assemblies; garage/house separations; required by code in specific locations', 'Pink or yellow core; core contains glass fibres that hold the panel together under heat; ULC-listed assembly must be followed exactly'],
                                        ['Moisture-resistant (MR / "green board")', 'Wet areas: behind tile in bathrooms and kitchens; NOT rated for direct water exposure', 'Green face paper; not a vapour barrier; cement board preferred for shower surrounds'],
                                        ['Cement board (Durock, Hardiebacker)', 'Tile substrate in wet areas, showers, tub surrounds, floors', 'Cement and aggregate core; not affected by water; requires alkali-resistant mesh tape at joints'],
                                        ['Acoustic drywall', 'Party walls, home theatres, mechanical rooms where sound transmission control is required', 'Heavier core with damping compound; used with resilient channels for maximum STC rating'],
                                        ['Sag-resistant ceiling board', 'Horizontal ceiling applications where standard board may sag between framing', 'Denser core; required for ceilings with framing at 600 mm o.c.'],
                                    ],
                                },
                                {
                                    type: 'infoBox',
                                    title: 'Drywall Installation Sequence and Key Rules',
                                    items: [
                                        'Ceilings first, then walls — wall panels support the ceiling panel edges and reduce the number of fasteners needed at the ceiling perimeter',
                                        'Hang panels perpendicular to framing members wherever possible — increases strength and reduces the number of butt joints',
                                        'Stagger all vertical joints — no two adjacent panels should have a joint on the same stud',
                                        'Keep all joints off the corners of door and window openings — corner joints crack under structural movement; cut panels so joints are at least 200 mm away from corners',
                                        'Screws 300 mm o.c. on ceilings, 400 mm o.c. on walls in the field; 200 mm o.c. at edges — follow ULC assembly requirements for fire-rated assemblies exactly',
                                        'Set screw depth so the head dimples the paper without breaking through — a broken paper face loses holding power and creates a bump under finish',
                                        'Double-layer fire-rated assemblies: first layer fastened normally; second layer offset from first layer joints and attached with longer screws or adhesive plus screws',
                                    ],
                                },
                                {
                                    type: 'table',
                                    headers: ['Ceiling System', 'Description', 'Application'],
                                    rows: [
                                        ['Direct-attached drywall ceiling', 'Drywall screwed directly to ceiling joists or truss bottom chords', 'Standard residential; lowest cost; height fixed by framing'],
                                        ['Resilient channel ceiling', 'Hat-channel screwed to joists; drywall screwed to channel only — no direct contact with structure; decouples the ceiling from structure', 'Noise and vibration isolation between floors; STC improvement in multi-unit residential'],
                                        ['Suspended T-bar ceiling (acoustical tile)', 'Hanger wires from structure support main tees; cross tees snap between main tees; tiles drop into grid', 'Commercial offices, retail, corridors; provides access to plenum above; easy to reconfigure; tiles are 600×600 or 600×1200 mm'],
                                        ['Demountable wall systems', 'Factory-manufactured steel or aluminium framed partitions with snap-in panels; no drywall mud required', 'Commercial tenant fit-up; can be relocated without demolition; fire-rated versions available'],
                                    ],
                                },
                            ],
                        },
                        {
                            id: 'ch13-s2',
                            title: '13.2 Flooring Installation',
                            content: [
                                {
                                    type: 'paragraph',
                                    text: 'Carpenters install a wide range of finish flooring types. Each requires specific substrate preparation, acclimatization, installation method, and expansion allowance. Failure to follow these requirements results in squeaking, gapping, buckling, or delamination.',
                                },
                                {
                                    type: 'keyTerm',
                                    term: 'Acclimatization',
                                    definition: 'The process of storing flooring material in the installation space at the expected in-service temperature and humidity for a minimum period (typically 48–72 hours, or as specified by the manufacturer) before installation. Wood-based flooring expands and contracts with moisture changes — installing without acclimatization causes gapping in dry seasons or buckling in humid seasons.',
                                },
                                {
                                    type: 'table',
                                    headers: ['Flooring Type', 'Installation Method', 'Key Requirements'],
                                    rows: [
                                        ['Solid hardwood', 'Nail or staple to wood subfloor (minimum 19 mm); blind-nail through tongue at 45°; face-nail first and last rows where blind-nailing is impossible', 'Acclimatize minimum 72 hours; maintain 10–12 mm expansion gap at all walls and fixed objects; do not install below grade; sub-floor moisture content must be within 4% of flooring MC'],
                                        ['Engineered hardwood', 'Float (click-lock), glue-down, or staple depending on product; can be installed below grade', 'Acclimatize per manufacturer; expansion gap at perimeter; floating floors must not be fastened to walls or transitions'],
                                        ['Laminate flooring', 'Float only (click-lock); never glue or nail; foam or cork underlayment required', 'Acclimatize 48 hours minimum; 10 mm expansion gap at all perimeters; stagger end joints minimum 300 mm between rows; keep dry — laminate swells permanently when wet'],
                                        ['LVP (Luxury Vinyl Plank)', 'Float (click-lock) or glue-down; very stable dimensionally; can go below grade', 'Expansion gap at perimeter (typically 6 mm); underlayment as specified; subfloor flatness critical — 3 mm in 1.8 m maximum; most products do not require acclimatization'],
                                        ['Ceramic / porcelain tile', 'Thin-set adhesive mortar over cement board or approved substrate; back-butter large-format tiles', 'Subfloor deflection must be < L/360 of span; expansion joints at perimeter and in field for large areas; grout joints sized per tile format; wet cut only for porcelain (silica hazard)'],
                                        ['Underlayment', 'Plywood or OSB panel installed over subfloor to smooth surface and add thickness before flooring', 'Joints must not align with subfloor joints; fasten 150 mm o.c. throughout; fill any gaps with floor-levelling compound before installing finish flooring'],
                                        ['Access flooring', 'Modular panels on adjustable pedestals; creates raised floor plenum for mechanical/electrical services', 'Pedestal height adjusted for level; panels click or screw to pedestal heads; load rating must match intended use'],
                                    ],
                                },
                            ],
                        },
                ...
                // CHAPTER 14 — INTERIOR DOORS, WINDOWS, STAIRS AND FINISH COMPONENTS (MWA F-19, F-20)
                {
                    id: 'ch-14',
                    number: 14,
                    title: 'Interior Doors, Windows, Stairs and Finish Components',
                    subtitle: 'MWA F-19 · Installs Interior Doors and Windows (31%) & F-20 · Constructs Finish Components and Stairs (35%)',
                    isFree: false,
                    estimatedMinutes: 65,
                    sections: [
                        {
                            id: 'ch14-s1',
                            title: '14.1 Interior Door and Window Installation',
                            content: [
                                {
                                    type: 'paragraph',
                                    text: 'Interior doors and windows require accurate shimming, consistent reveals, and properly mortised hardware to operate correctly and look professional. Unlike exterior units, interior doors are not flashed — but plumb, level, and square installation is equally critical.',
                                },
                                {
                                    type: 'table',
                                    headers: ['Step / Component', 'Key Requirements'],
                                    rows: [
                                        ['Pre-hung door unit', 'Factory-assembled door, hinges, and jamb as a single unit; simplest and most common installation method; hinge jamb is shimmed plumb first, then latch jamb is set for consistent reveal'],
                                        ['Shimming', 'Pairs of opposing tapered shims at every hinge location and strike plate location; shims must bear solidly against the framing stud — not just the trimmer; score shims flush with jamb face after securing'],
                                        ['Reveal', 'The consistent gap between the door edge and the jamb face on all three sides (hinge, top, latch); standard reveal 3–4 mm; inconsistent reveal indicates the jamb is not plumb or the door is not square'],
                                        ['Head jamb level', 'Head (top) jamb must be level; if floor is out of level, adjust hinge jamb height so the head is level; door will not close properly if head is out of level'],
                                        ['Casing (interior door trim)', 'Applied to both faces of the wall around the door; reveals at jamb edge typically 6 mm; mitre joints at top corners (45°); nail to jamb and to wall framing stud; set nails and fill'],
                                        ['Door hardware — hinges', 'Mortise hinges flush with jamb and door edge; depth of mortise = leaf thickness; screws must engage the framing stud through the jamb (at least one screw per hinge into stud for security)'],
                                        ['Door hardware — locksets', 'Bore holes per manufacturer\'s template; backset (distance from door edge to centre of knob/lever) is 60 mm or 70 mm — confirm before boring; align strike plate mortise with latch bolt exactly'],
                                        ['Interior windows', 'Set plumb, level, and square; shim at sill, head, and jambs; fasten through jamb into trimmer; interior stool and apron trim at sill; casing on sides and head matching door casing profile'],
                                    ],
                                },
                            ],
                        },
                        {
                            id: 'ch14-s2',
                            title: '14.2 Stair Construction',
                            content: [
                                {
                                    type: 'paragraph',
                                    text: 'Stairs are one of the most calculation-intensive tasks in finish carpentry and one of the most code-regulated elements in the building. Knowing the NBC stair geometry requirements, the calculation sequence, and the names of all components is essential — stair questions appear consistently on the Red Seal exam.',
                                },
                                {
                                    type: 'table',
                                    headers: ['Stair Component', 'Definition'],
                                    rows: [
                                        ['Stringer (carriage)', 'The inclined structural member supporting the treads and risers; cut stringers have the profile notched out; solid stringers have housed (routed) grooves; minimum three stringers for stairs wider than 900 mm'],
                                        ['Tread', 'The horizontal walking surface of each step; measured from nosing to nosing = unit run; nosing projects beyond the riser face typically 25–30 mm'],
                                        ['Riser', 'The vertical face between treads; closed risers are solid; open risers have no riser board; riser height = unit rise'],
                                        ['Nosing', 'The projecting front edge of the tread overhanging the riser below; provides visual cue for foot placement; nosing profile rounded or bevelled per code'],
                                        ['Newel post', 'The main structural post of the balustrade system at the top, bottom, and turns of the stair; anchored to the framing structure — not just the treads'],
                                        ['Balusters (spindles)', 'Vertical members between handrail and tread or bottom rail; maximum spacing 100 mm (a 100 mm sphere must not pass through any opening)'],
                                        ['Handrail', 'The graspable rail along the open side of the stair; must be graspable (round or oval profile 30–45 mm diameter or equivalent); height measured vertically from nosing'],
                                        ['Guardrail', 'The protective barrier at open sides of landings, balconies, and stairs to prevent falls; height measured vertically from the floor or nosing'],
                                        ['Headroom', 'Vertical clearance measured from the nosing line (a line connecting all nosings) to any overhead obstruction; measured vertically'],
                                        ['Landing', 'A level platform between stair flights; minimum dimension equal to the stair width; required at every change of direction and at maximum vertical rise intervals per code'],
                                    ],
                                },
                                {
                                    type: 'table',
                                    headers: ['NBC Requirement', 'Residential (Part 9)', 'Commercial / Assembly (Part 3)'],
                                    rows: [
                                        ['Maximum unit rise', '200 mm', '180 mm'],
                                        ['Minimum unit run', '235 mm', '280 mm'],
                                        ['Comfort check (rise + run)', '550–700 mm recommended', '550–700 mm recommended'],
                                        ['Maximum variation between risers in one flight', '5 mm', '5 mm'],
                                        ['Minimum headroom', '1,950 mm', '2,050 mm'],
                                        ['Handrail height (from nosing)', '865–965 mm', '865–965 mm'],
                                        ['Guardrail height — floor (≤ 1.8 m above grade)', '900 mm minimum', '1,070 mm minimum'],
                                        ['Guardrail height — floor (> 1.8 m above grade)', '1,070 mm minimum', '1,070 mm minimum'],
                                        ['Maximum baluster / spindle spacing', '100 mm (sphere test)', '100 mm (sphere test)'],
                                        ['Minimum stair width (residential)', '860 mm', '1,100 mm (varies by occupancy)'],
                                    ],
                                },
                                {
                                    type: 'infoBox',
                                    title: 'Stair Layout Calculation Sequence',
                                    items: [
                                        '1. Measure total rise: floor-to-floor height (top of lower finish floor to top of upper finish floor)',
                                        '2. Determine number of risers: Total rise ÷ target unit rise (aim for ~175 mm); round to nearest whole number',
                                        '3. Calculate actual unit rise: Total rise ÷ number of risers; verify ≤ 200 mm (residential) or ≤ 180 mm (commercial)',
                                        '4. Select unit run: must be ≥ 235 mm (residential); check comfort formula: rise + run = 550–700 mm',
                                        '5. Calculate total run: unit run × (number of risers − 1); the number of treads = number of risers − 1',
                                        '6. Calculate stringer length: √(total rise² + total run²); add 150–200 mm for top and bottom bearing',
                                        '7. Verify headroom: draw the nosing line and check clearance to ceiling or floor above',
                                        '8. Verify variation: all risers in one flight must be within 5 mm of each other — this is checked during installation, not just calculation',
                                    ],
                                },
                                {
                                    type: 'keyTerm',
                                    term: 'Comfort Check Formula',
                                    definition: 'A rule-of-thumb to verify stair geometry feels natural to climb: unit rise + unit run should equal between 550 mm and 700 mm. Example: 175 mm rise + 240 mm run = 415 mm — too tight. Adjust run to 260 mm: 175 + 260 = 435 mm — still low. Try 175 mm rise + 280 mm run = 455 mm. The formula confirms a comfortable, safe stair that is neither too steep nor too shallow.',
                                },
                            ],
                        },
                        {
                            id: 'ch14-s3',
                            title: '14.3 Finish Components and Trim',
                            content: [
                                {
                                    type: 'paragraph',
                                    text: 'Finish carpentry includes all the trim, moulding, shelving, cabinetry, and accessories installed after the drywall is painted. Precision, clean joints, and consistent reveals define quality finish work.',
                                },
                                {
                                    type: 'table',
                                    headers: ['Finish Component', 'Key Installation Notes'],
                                    rows: [
                                        ['Base moulding (baseboard)', 'Installed after flooring or with appropriate gap for flooring thickness; inside corners coped (not mitred) for wood profiles — coped joints stay tight as wood moves; outside corners mitred at 45°; nail to bottom plate and into studs'],
                                        ['Crown moulding', 'Installed at wall-ceiling junction; spring angle (typically 38° or 45° from wall) must be consistent; inside corners coped; outside corners mitred; use a story pole to mark consistent height around the room before cutting'],
                                        ['Door and window casing', '6 mm reveal at jamb edge; mitre joints at top corners; nail to jamb and into framing stud; set nails; consistent profile throughout the project'],
                                        ['Shelving and closet systems', 'Locate all studs before fastening; use appropriate anchors for drywall-only locations; shelf standards plumb and at equal heights; adjustable shelving allows future flexibility'],
                                        ['Cabinet installation', 'Wall cabinets first, then base cabinets; locate and mark all studs before hanging; use a ledger board temporarily to support wall cabinets during installation; shim base cabinets level — scribe to wall and floor irregularities; fasten through cabinet back into studs with minimum 65 mm screws'],
                                        ['Backing (blocking)', 'Installed in the framing rough-in stage at known locations for future hardware: grab bars, handrails, TV mounts, heavy shelving; 38×140 mm blocking between studs; documented on as-built drawings for future reference'],
                                    ],
                                },
                            ],
                        },
        ...
        // ============================================================
        // PART 7 — RENOVATIONS, REFERENCE, AND EXAM PREP
        // MWA G: Performs Renovations (10%)
        // ============================================================
        {
            id: 'part-7',
            number: 7,
            title: 'Renovations, Reference, and Exam Prep',
            description: 'Renovation-specific skills, a complete formula and reference chapter, and a full mock exam. MWA G carries 10 questions split evenly across G-21 (48%) and G-22 (52%).',
            chapters: [

                // CHAPTER 15 — RENOVATION SUPPORT AND CONSTRUCTION ACTIVITIES (MWA G-21, G-22)
                {
                    id: 'ch-15',
                    number: 15,
                    title: 'Renovation Work',
                    subtitle: 'MWA G-21 · Renovation-Specific Support Activities (48%) & G-22 · Renovation-Specific Construction Activities (52%)',
                    isFree: false,
                    estimatedMinutes: 55,
                    sections: [
                        {
                            id: 'ch15-s1',
                            title: '15.1 Hazardous Materials and Site Protection',
                            content: [
                                {
                                    type: 'paragraph',
                                    text: 'Renovation carpentry differs fundamentally from new construction — the carpenter works within an existing structure that may contain hazardous materials, hidden utilities, and structural elements that must be protected or temporarily supported. Recognizing hazards, stopping work, and following the correct abatement protocol before proceeding is a legal requirement and a frequent exam topic.',
                                },
                                {
                                    type: 'table',
                                    headers: ['Hazardous Material', 'Where Found in Older Buildings', 'Required Action Before Carpentry Resumes'],
                                    rows: [
                                        ['Asbestos', 'Floor tiles, ceiling tiles, pipe insulation, stipple/textured paint, drywall joint compound (pre-1984), roof shingles, exterior cladding — buildings pre-1990', 'Stop work immediately; do not disturb; arrange testing by an accredited laboratory; licensed abatement contractor removes or encapsulates before any carpentry work resumes'],
                                        ['Lead-based paint', 'Any painted surface in buildings pre-1978; high risk on trim, windows, and exterior surfaces', 'Test before sanding, grinding, burning, or demolishing; certified lead removal workers; HEPA vacuum; wet methods to control dust; isolate work area'],
                                        ['Silica', 'Generated by cutting concrete, mortar, brick, fibre-cement siding, ceramic tile', 'Wet cutting or local exhaust ventilation at source; P100 half-face respirator minimum; HEPA vacuum; do not dry sweep'],
                                        ['Mould', 'Water-damaged framing, drywall, subfloor, insulation — anywhere chronic moisture is present', 'Identify and eliminate moisture source first; mould remediation before any carpentry work; PPE (N95 minimum, gloves, eye protection) during disturbance and cleanup'],
                                        ['PCBs (Polychlorinated Biphenyls)', 'Caulking in commercial buildings pre-1986; fluorescent light ballasts, transformers', 'Stop work; engage environmental consultant; certified contractor required; all material disposed of as hazardous waste'],
                                        ['Wood dust', 'Generated by all sawing, routing, planning, and sanding operations', 'Dust collection at source; N95 minimum; higher protection for MDF, western red cedar, and exotic species; never dry sweep — HEPA vacuum or damp mop'],
                                    ],
                                },
                                {
                                    type: 'table',
                                    headers: ['Protection Method', 'Application'],
                                    rows: [
                                        ['Dust barriers (poly sheeting)', 'Seal off work area from occupied spaces; zippered access panels; negative air pressure using exhaust fan to prevent dust migration; critical for asbestos, lead, and mould work'],
                                        ['Floor protection', 'Ram board, rosin paper, or poly sheeting taped at edges; protects finished flooring from foot traffic, tool drops, and debris during renovation work'],
                                        ['Hoarding', 'Temporary plywood or steel stud and drywall enclosure around the work area; provides weather protection, heat retention, and security on commercial sites; required by municipal bylaws in many jurisdictions'],
                                        ['Temporary shoring', 'Required any time a load-bearing wall, column, beam, or floor is cut, removed, or modified; installed before any structural element is cut or removed'],
                                    ],
                                },
                            ],
                        },
                        {
                            id: 'ch15-s2',
                            title: '15.2 Temporary Shoring and Structural Support',
                            content: [
                                {
                                    type: 'paragraph',
                                    text: 'Temporary shoring is one of the most critical skills in renovation carpentry. Any time a load-bearing element is to be cut, removed, or modified, the loads it carries must be transferred by a temporary system before work begins. Failure to shore adequately is a leading cause of serious injuries and fatalities in renovation work.',
                                },
                                {
                                    type: 'keyTerm',
                                    term: 'Temporary Shoring',
                                    definition: 'A temporary structural system installed to carry loads that would normally be carried by a wall, beam, column, or floor assembly that is being removed or modified. Shoring must be installed BEFORE the permanent structure is cut or removed, and must remain in place until the new permanent structure is complete and capable of carrying the load.',
                                },
                                {
                                    type: 'infoBox',
                                    title: 'Temporary Shoring Principles',
                                    items: [
                                        'Shore BEFORE you cut — the temporary system must be in place and carrying load before any saw touches the existing structure',
                                        'Identify the load path — trace loads from roof to foundation; every load must have a complete path through the temporary system to the ground',
                                        'Needle beams: horizontal beams inserted through the wall above the area to be removed, bearing on shoring posts on both sides of the wall; used to carry floor or roof loads while the wall below is removed',
                                        'Temporary stud walls: built parallel to and close to the bearing wall being removed; sized to carry the load; mudsills distribute load to the floor below',
                                        'Double the floor framing below shoring posts if posts bear on a floor — point loads from posts can exceed the floor joist capacity',
                                        'Shore each floor independently when working in multi-storey buildings — loads must be tracked all the way to the foundation',
                                        'Consult a structural engineer for any significant load-bearing modification — the carpenter is not a designer; the engineer specifies what shoring is required',
                                    ],
                                },
                            ],
                        },
                        {
                            id: 'ch15-s3',
                            title: '15.3 Joining New to Existing Construction',
                            content: [
                                {
                                    type: 'paragraph',
                                    text: 'Renovation construction requires carpenters to match new work to existing conditions that are rarely perfectly plumb, level, or square. Scribing, shimming, and matching existing profiles are the core skills of Task G-22.',
                                },
                                {
                                    type: 'table',
                                    headers: ['Technique', 'Description and Application'],
                                    rows: [
                                        ['Scribing', 'Transferring the irregular profile of an existing surface onto a new piece so it can be cut to fit exactly; set a compass or scribing tool to the widest gap between the new piece and the existing surface; run the tool along the existing surface while the pencil marks the cut line on the new piece; cut on the line for a perfect fit'],
                                        ['Shimming', 'Using tapered wood or composite shims to bring new framing, cabinets, or trim to plumb and level against an out-of-plumb existing wall or floor; shims installed in opposing pairs for maximum bearing and stability'],
                                        ['Matching existing profiles', 'New trim or moulding must match the profile of existing trim; bring a sample to a millwork supplier to identify the profile; if the profile is no longer manufactured, a custom knife can be ground, or the profile can be built up from multiple standard mouldings'],
                                        ['Sistering', 'Reinforcing a damaged, undersized, or notched existing joist by fastening a new full-length member alongside it; both members must bear fully at each end; use construction adhesive and nails or screws for full composite action'],
                                        ['Material reclamation', 'Salvaging existing materials (flooring, trim, brick, structural lumber) from demolition for reuse; careful deconstruction required; denail and clean salvaged lumber before reuse; inspect for hidden fasteners, splits, and decay'],
                                        ['Matching finishes', 'New drywall joints feathered to blend with existing texture; new paint colour matched using a paint spectrometer at a paint supplier; new stain matched by testing on scrap of the same species and comparing in the same lighting conditions'],
                                    ],
                                },
                                {
                                    type: 'keyTerm',
                                    term: 'Underpinning',
                                    definition: 'The process of extending or strengthening the foundation of an existing building — typically to allow excavation of a deeper basement or to support a building whose foundation is inadequate. Underpinning is done in alternating sections (never the full length at once) to prevent settlement. It requires engineering and specialist execution — carpenters may construct formwork for underpinning sections.',
                                },
                            ],
                        },
                    ],
                ...
                // CHAPTER 16 — CARPENTRY FORMULAS AND REFERENCE
                {
                    id: 'ch-16',
                    number: 16,
                    title: 'Carpentry Formulas and Reference',
                    subtitle: 'Complete formula reference — official Red Seal formulas, rafter factors, stair calculations, and trade reference tables',
                    isFree: false,
                    estimatedMinutes: 30,
                    sections: [
                        {
                            id: 'ch16-s1',
                            title: '16.1 Official Red Seal Formulas',
                            content: [
                                {
                                    type: 'paragraph',
                                    text: 'The following formulas are provided on the official Red Seal Carpenter exam information sheet. You will have access to them during the exam — but you must know how and when to apply each one. Practise every formula with worked examples until the process is automatic.',
                                },
                                {
                                    type: 'table',
                                    headers: ['Formula', 'Expression', 'Notes'],
                                    rows: [
                                        ['Area of a rectangle', 'A = L × W', 'Used for floor, wall, ceiling, and roof surface area calculations'],
                                        ['Area of a triangle', 'A = (B × H) ÷ 2', 'Used for gable end area and triangular roof sections'],
                                        ['Area of a circle', 'A = π × r²', 'Used for circular columns and curved features; π = 3.14'],
                                        ['Circumference of a circle', 'C = π × D  or  C = 2 × π × r', 'Used for round column forms and circular layouts'],
                                        ['Pythagorean theorem', 'c = √(a² + b²)', 'Squaring layout, rafter length, stringer length'],
                                        ['Rafter rise', 'Rise = Run × (unit rise ÷ unit run)', 'Unit run = 300 mm metric; 12" imperial'],
                                        ['Rafter run', 'Run = Span ÷ 2', 'For a symmetrical gable roof'],
                                        ['Volume', 'V = L × W × D', 'Concrete slab and footing volume in m³'],
                                    ],
                                },
                            ],
                        },
                        {
                            id: 'ch16-s2',
                            title: '16.2 Rafter Factor Table',
                            content: [
                                {
                                    type: 'paragraph',
                                    text: 'The rafter factor is the hypotenuse of a right triangle with one side equal to 1 unit of run and the other side equal to the unit rise for that pitch. Multiply the rafter factor by the total run to get the rafter line length. This is faster and equally accurate to the full Pythagorean calculation for every pitch.',
                                },
                                {
                                    type: 'table',
                                    headers: ['Pitch (rise:run)', 'Unit Rise (metric)', 'Rafter Factor', 'Hip/Valley Factor'],
                                    rows: [
                                        ['3:12', '75 mm per 300 mm run', '1.031', '1.436'],
                                        ['4:12', '100 mm per 300 mm run', '1.054', '1.452'],
                                        ['5:12', '125 mm per 300 mm run', '1.083', '1.474'],
                                        ['6:12', '150 mm per 300 mm run', '1.118', '1.500'],
                                        ['7:12', '175 mm per 300 mm run', '1.158', '1.530'],
                                        ['8:12', '200 mm per 300 mm run', '1.202', '1.564'],
                                        ['9:12', '225 mm per 300 mm run', '1.250', '1.601'],
                                        ['10:12', '250 mm per 300 mm run', '1.302', '1.642'],
                                        ['11:12', '275 mm per 300 mm run', '1.357', '1.684'],
                                        ['12:12', '300 mm per 300 mm run', '1.414', '1.732'],
                                    ],
                                },
                                {
                                    type: 'infoBox',
                                    title: 'How to Use the Rafter Factor Table',
                                    items: [
                                        'Common rafter line length = total run (mm) × rafter factor',
                                        'Example: 6:12 pitch, building span 9 m → run = 4,500 mm → line length = 4,500 × 1.118 = 5,031 mm',
                                        'Add overhang: horizontal overhang × rafter factor = overhang line length; add to line length',
                                        'Deduct ridge shortening: half the ridge board thickness measured horizontally at the pitch angle',
                                        'Hip rafter line length = total run × hip/valley factor (hip run = same as common rafter run for a square hip)',
                                        'Valley rafter line length = total run × hip/valley factor (same calculation as hip)',
                                        'Jack rafter common difference = stud spacing × rafter factor (each successive jack is shorter by this amount)',
                                    ],
                                },
                            ],
                        },
                        {
                            id: 'ch16-s3',
                            title: '16.3 Stair Reference',
                            content: [
                                {
                                    type: 'table',
                                    headers: ['Stair Calculation', 'Formula', 'Example'],
                                    rows: [
                                        ['Number of risers', 'Total rise ÷ target unit rise; round to whole number', '2,380 mm ÷ 175 mm = 13.6 → 14 risers'],
                                        ['Actual unit rise', 'Total rise ÷ number of risers', '2,380 ÷ 14 = 170 mm ✓ (≤ 200 mm)'],
                                        ['Number of treads', 'Number of risers − 1', '14 − 1 = 13 treads'],
                                        ['Total run', 'Unit run × number of treads', '240 mm × 13 = 3,120 mm'],
                                        ['Stringer length', '√(total rise² + total run²)', '√(2,380² + 3,120²) = √(5,664,400 + 9,734,400) = √15,398,800 = 3,924 mm'],
                                        ['Comfort check', 'Rise + run = 550–700 mm', '170 + 240 = 410 mm — too low; increase run to 270 mm: 170 + 270 = 440 mm — adjust further'],
                                        ['Maximum riser variation', '5 mm maximum difference between any two risers in one flight', 'If floor is not perfectly level, distribute the variation across all risers'],
                                    ],
                                },
                            ],
                        },
                        {
                            id: 'ch16-s4',
                            title: '16.4 Unit Conversions and Quick Reference',
                            content: [
                                {
                                    type: 'table',
                                    ...
                                    rows: [
                                        ...
                                        ['1 roofing square', '100 ft² = 9.29 m²'],
                                        ['Standard unit run (metric)', '300 mm'],
                                        ['Standard unit run (imperial)', '12 inches'],
                                        ['π (pi)', '3.14 (as provided on exam)'],
                                        ['45° diagonal multiplier', '1.414 (√2)'],
                                        ['Standard stud height', '2,440 mm (8 ft)'],
                                        ['Standard drywall sheet', '1,220 × 2,440 mm (4 × 8 ft) = 2.97 m²'],
                                        ['Standard OSB/plywood panel', '1,220 × 2,440 mm = 2.97 m²'],
                                    ],
                                },
                                {
                                    type: 'table',
                                    headers: ['NBC Stair Limit', 'Residential', 'Commercial'],
                                    rows: [
                                        ['Max unit rise', '200 mm', '180 mm'],
                                        ['Min unit run', '235 mm', '280 mm'],
                                        ['Min headroom', '1,950 mm', '2,050 mm'],
                                        ['Handrail height', '865–965 mm', '865–965 mm'],
                                        ['Guardrail (≤ 1.8 m above grade)', '900 mm', '1,070 mm'],
                                        ['Guardrail (> 1.8 m above grade)', '1,070 mm', '1,070 mm'],
                                        ['Max baluster spacing', '100 mm', '100 mm'],
                                        ['Max riser variation', '5 mm', '5 mm'],
                                    ],
                                },
                            ],
                        },
                ...
                // CHAPTER 17 — MOCK EXAM AND EXAM STRATEGY
                {
                    id: 'ch-17',
                    number: 17,
                    title: 'Red Seal Mock Exam and Exam Strategy',
                    subtitle: '100-question timed practice exam — 3 hours — full MWA coverage',
                    isFree: false,
                    estimatedMinutes: 5,
                    isMockExam: true,
                    sections: [
                        {
                            id: 'ch17-s1',
                            title: '17.1 Exam Overview',
                            content: [
                                {
                                    type: 'paragraph',
                                    text: 'The Red Seal Interprovincial Exam for Carpenter (403A) consists of 100 multiple-choice questions to be completed in 3 hours. The passing score is 70% (70 correct answers). Questions are drawn from all seven MWAs in proportion to their stated weightings.',
                                },
                                {
                                    type: 'table',
                                    headers: ['MWA', 'Title', 'Weight', 'Questions'],
                                    rows: [
                                        ['A', 'Performs Common Occupational Skills', '12%', '12'],
                                        ['B', 'Performs Planning and Layout', '14%', '14'],
                                        ['C', 'Performs Concrete Work', '16%', '16'],
                                        ['D', 'Performs Framing', '20%', '20'],
                                        ['E', 'Performs Exterior Finishing', '14%', '14'],
                                        ['F', 'Performs Interior Finishing', '14%', '14'],
                                        ['G', 'Performs Renovations', '10%', '10'],
                                        ['', 'TOTAL', '100%', '100'],
                                    ],
                                },
                                {
                                    type: 'infoBox',
                                    title: 'Exam Strategy — Where to Focus Your Time',
                                    items: [
                                        'MWA D (Framing) — 20 questions: the single highest-value section; master rafter calculations, I-joist rules, wall components, and truss handling',
                                        'MWA C (Concrete) — 16 questions: Task C-8 Formwork alone is 12 questions; lateral pressure, form components, systems, and stripping times are all tested',
                                        'MWA B (Layout) — 14 questions: calculation questions appear here; practise diagonal check, stud count, rafter, and stair calculations until automatic',
                                        'MWA E and F (Finishing) — 14 questions each: flashing sequence, NBC stair code, drywall types, flooring installation are the highest-yield topics',
                                        'MWA A (Foundations) — 12 questions: safety hierarchy, PPE standards, LOTO procedure, PAT rules, and ladder/scaffold requirements',
                                        'MWA G (Renovations) — 10 questions: hazardous material recognition and response, temporary shoring principles, scribing and joining new to existing',
                                        'Question types: approximately 75–85% are procedural and application questions — they describe a situation and ask what you would do; read every word carefully',
                                        'Never leave a question blank — there is no penalty for a wrong answer; eliminate obviously wrong choices and choose the best remaining option',
                                        'For calculation questions: estimate first, then calculate; if your calculated answer is far from your estimate, recheck before moving on',
                                    ],
                                },
                            ],
                        },
...
// Normalized course export for app (same shape as plumberCourseData / hairstylistCourse)
...
export default carpenterCourseData;