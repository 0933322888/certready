        ...
        chapters: [
            ...
            practiceQuestions: [
              {
                ...
                options: [
                  ...
                  'Class A is a loop circuit that remains functional despite a single open or short fault; Class B is a T-tap circuit that is disabled by a single open fault',
                  'Class A circuits require end-of-line resistors; Class B circuits do not',
                  'Class A uses addressable devices; Class B uses conventional (zoned) devices',
                ],
                correctIndex: 1,
                explanation: 'Class A wiring loops both conductors back to the FACP, so a single break (open) in the circuit does not interrupt communication with devices beyond the break. Class B uses a T-tap (home run) configuration with an end-of-line resistor; a single open fault disables the circuit beyond the break. Class A is required by the NBC in high-rise buildings.',
              },
              {
                id: 'elec-q12-2',
                ...
                correctIndex: 2,
                explanation: 'Cat 6A (Augmented Category 6) is rated to 500 MHz and supports 10GBASE-T (10 Gbps Ethernet) at full channel length of 100 metres. Cat 6 only supports 10 Gbps up to approximately 55 metres. Cat 5e supports only 1 Gbps.',
              },
            ],
          },
          ...
          // ─────────────────────────────────────────────────────────
          {
            ...
            practiceQuestions: [
              {
                id: 'elec-q13-1',
                question: 'Which open-standard protocol is most commonly used for communication between building automation system (BAS) components from different manufacturers?',
                options: ['Modbus RTU', 'BACnet (ANSI/ASHRAE 135)', 'Profibus DP', 'DeviceNet'],
                correctIndex: 1,
                explanation: 'BACnet (ANSI/ASHRAE 135) is the dominant open-standard protocol for building automation systems in North America. It was specifically developed for building automation applications (HVAC, lighting, security) and supports multiple physical layers (BACnet/IP, BACnet MS/TP, BACnet wireless). Modbus and Profibus are more common in industrial automation.',
              },
            ],
          },
  
          // ─────────────────────────────────────────────────────────
          // CHAPTER 14 — Formulas Reference, Glossary & Red Seal Exam Strategy
          // ─────────────────────────────────────────────────────────
          {
            id: 'elec-ch-14',
            number: 14,
            title: 'Formulas Reference, Key Terms, and Red Seal Exam Strategy',
            subtitle: 'Complete Formula Sheet · Essential Terminology · Exam Strategy for 100-Question Red Seal Exam',
            isFree: false,
            estimatedMinutes: 60,
            sections: [
              {
                id: 'elec-ch14-s1',
                title: '14.1 Electrical Formulas Reference',
                content: [
                  {
                    type: 'paragraph',
                    text: 'The Red Seal exam for Construction Electrician includes calculation-based questions. Memorize these fundamental formulas — they appear repeatedly across all MWA sections.',
                  },
                  {
                    type: 'infoBox',
                  ...
                  {
                    type: 'infoBox',
                    title: 'AC Circuit Formulas',
                    items: [
                      'Single-phase apparent power: S (VA) = V × I',
                      'Single-phase real power: P (W) = V × I × PF',
                      'Three-phase apparent power: S (VA) = √3 × VL × IL = 1.732 × VL × IL',
                      'Three-phase real power: P (W) = √3 × VL × IL × PF',
                      'Power factor: PF = P / S = kW / kVA (cosine of phase angle)',
                      'Reactive power: Q (VAR) = √(S² − P²)',
                      'Impedance: Z = √(R² + X²); XL = 2πfL; XC = 1/(2πfC)',
                    ],
                  },
                  {
                    type: 'infoBox',
                    ...
                    items: [
                      ...
                      'Efficiency: η% = Pout / Pin × 100% = Pout / (Pout + Ploss) × 100%',
                    ],
                  },
                  {
                    type: 'infoBox',
                    ...
                    items: [
                      ...
                      'Slip: s = (Ns − Nr) / Ns × 100%',
                      'Motor efficiency: η% = Pout / Pin × 100% = (HP × 746) / (V × I × PF × √3) × 100% (three-phase)',
                      'Horsepower: HP = (T × N) / 5252 (T in ft-lb, N in RPM)',
                      'Metric power: kW = HP × 0.7457',
                    ],
                  },
                  {
                    type: 'infoBox',
                    title: 'Voltage Drop Formulas',
                    items: [
                      'Single-phase: VD = 2 × L × R × I / 1000 (R in Ω/km, L in metres)',
                      'Three-phase: VD = √3 × L × R × I / 1000 (R in Ω/km, L in metres)',
                      'Percent voltage drop: VD% = VD / V_source × 100%',
                      'CEC recommended maximum: 3% for branch circuits; 5% total (feeder + branch)',
                    ],
                  },
                  {
                    type: 'infoBox',
                    title: 'Conduit Fill and Other Formulas',
                    items: [
                      'Circle area: A = π × r² = π × d² / 4 (where d = diameter)',
                      'π = 3.1416',
                      'Conduit fill: conductor cross-section sum / conduit internal area ≤ 40% (3+ wires)',
                      'Ohm\'s law for parallel resistors: 1/Rt = 1/R1 + 1/R2 + 1/R3 ...',
                      'Series resistors: Rt = R1 + R2 + R3 ...',
                      'Metric conversions: 1 inch = 25.4 mm; 1 ft = 0.3048 m; 1 HP = 746 W; 1 kWh = 3.6 MJ',
                    ],
                  },
                ],
              },
              {
                id: 'elec-ch14-s2',
                title: '14.2 Key Terms and Acronyms',
                content: [
                  {
                    type: 'infoBox',
                    title: 'Essential Acronyms',
                    items: [
                      ...
                      'DCS — Distributed Control System; DDC — Direct Digital Control',
                      'EMC — Electromagnetic Compatibility; EMI — Electromagnetic Interference',
                      'EV — Electric Vehicle',
                      'FLA — Full Load Amps; FLC — Full Load Current',
                      'GFP — Ground Fault Protection; GFCI — Ground Fault Circuit Interrupter',
                      'GUI — Graphical User Interface; HMI — Human Machine Interface',
                      'HVAC — Heating, Ventilation and Air-Conditioning',
                      'IGBT — Insulated Gate Bipolar Transistor',
                      'IoT — Internet of Things',
                      'kVA — Kilovolt-Amperes; kW — Kilowatts; kWh — Kilowatt-hours',
                      'LEED — Leadership in Energy and Environmental Design',
                      'LOTO — Lock-Out / Tag-Out',
                      'MCC — Motor Control Centre',
                      'MOV — Metal Oxide Varistor',
                      'NBC — National Building Code; NFC — National Fire Code',
                      'NEMA — National Electrical Manufacturers\' Association',
                      'NETA — North American Electrical Testing Association',
                      'NMD — Non-Metallic sheathed cable (Dry locations)',
                      'OEM — Original Equipment Manufacturer',
                      'OH&S — Occupational Health and Safety',
                      'PA — Public Address; PAT — Powder-Actuated Tool',
                      ...
                      'RMC — Rigid Metal Conduit; EMT — Electrical Metallic Tubing',
                      'SCADA — Supervisory Control and Data Acquisition',
                      'SCR — Silicon Controlled Rectifier; IGBT — Insulated Gate Bipolar Transistor',
              ...
              {
                id: 'elec-ch14-s3',
                title: '14.3 Red Seal Exam Strategy — Construction Electrician',
                content: [
                  {
                    type: 'paragraph',
                    text: 'The Red Seal Interprovincial Exam for Construction Electrician has 100 multiple-choice questions with a passing mark of 70% (70 correct). Use the exam weighting to focus your study time wisely.',
                  },
                  {
                    type: 'infoBox',
                    title: 'Exam Weighting by MWA (100 Questions Total)',
                    items: [
                      'MWA A — Performs Common Occupational Skills: 12 questions',
                      'MWA B — Generating, Distribution and Service Systems: 26 questions',
                      'MWA C — Wiring Systems: 34 questions (HIGHEST — prioritize this!)',
                  ...
                  },
                  {
                    ...
                    items: [
                      'MWA C is 34% of the exam — mastering raceways, conductors, branch circuits, and lighting gives you the most points',
                      'MWA B is 26% — know your services (single and three-phase), protection devices, grounding/bonding, and transformer calculations',
                      'MWA D is 18% — motor circuit sizing, starter logic, and VFD principles are frequently tested',
                      'Read every question carefully — eliminate obviously wrong answers first, then choose the BEST remaining answer',
                      'Code reference questions — know the CEC sections: Section 4 (conductors), Section 8 (load calculations), Section 10 (grounding), Section 12 (wiring methods), Section 26 (installation of equipment), Section 28 (motors)',
                      'Calculation questions — write down what is given, identify the formula, substitute values, double-check units',
                      'Flag questions you are uncertain about and return to them after answering all questions you know',
                      'Time management — approximately 90 seconds per question; do not spend more than 3 minutes on any single question',
                    ],
                  },
                ],
              },
            ...
            practiceQuestions: [
              {
                id: 'elec-q14-1',
                question: 'A three-phase, 600V motor draws 50A FLA at 0.85 power factor. What is the motor\'s real power consumption in kW?',
                options: ['30 kW', '44.2 kW', '52.1 kW', '61.4 kW'],
                correctIndex: 1,
                explanation: 'P = √3 × VL × IL × PF = 1.732 × 600V × 50A × 0.85 = 44,166W ≈ 44.2 kW. The apparent power is √3 × 600 × 50 = 51,960 VA ≈ 52 kVA, and the real power is kVA × PF = 52 × 0.85 = 44.2 kW.',
              },
              {
                id: 'elec-q14-2',
                question: 'According to the Red Seal exam weighting, which MWA has the highest number of exam questions and should receive the most study time?',
                options: [
                  'MWA A — Common Occupational Skills (12%)',
                  'MWA B — Generating, Distribution and Service Systems (26%)',
                  'MWA C — Wiring Systems (34%)',
                  'MWA D — Motors and Control Systems (18%)',
                ],
                correctIndex: 2,
                explanation: 'MWA C (Wiring Systems) represents 34% of the Red Seal exam — the single largest section with 34 questions out of 100. This covers raceways, conductors, cables, enclosures, branch circuitry, lighting, HVAC connections, electric heating, and emergency lighting. Mastering this section is critical to passing.',
              },
              {
                id: 'elec-q14-3',
                question: 'A 240V, single-phase circuit runs 75 metres to supply a 20A continuous load. The #10 AWG copper conductors have a resistance of 3.277 Ω/km. What is the voltage drop, and does it comply with the CEC branch circuit recommendation?',
                options: [
                  'VD = 4.9V (2.0%) — complies with the 3% recommendation',
                  'VD = 9.8V (4.1%) — exceeds the 3% recommendation',
                  'VD = 19.7V (8.2%) — significantly exceeds the 3% recommendation',
                  'VD = 2.5V (1.0%) — well within the 3% recommendation',
                ],
                correctIndex: 1,
                explanation: 'VD = 2 × L × R × I / 1000 = 2 × 75m × 3.277 Ω/km × 20A / 1000 = 2 × 75 × 0.003277 × 20 = 9.83V. VD% = 9.83V / 240V = 4.1%. This exceeds the CEC recommended 3% maximum for branch circuits, so a larger conductor (#8 AWG) should be selected.',
              },
            ],
          },
        ],
