...
const QUESTIONS = [
  {
    tradeSlug: "construction-electrician", topicId: "mwa-a-safety", topicLabel: "MWA A — Safety",
  ...
  },
  {
    ...
    options: ["Class G (General) — rated to 2,200V", "Class C (Conductive) — no electrical protection", "Class E (Electrical) — rated to 20,000V", "Class B — rated to 10,000V"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["Restricted egress in an emergency", "Electrical shock from energized equipment", "Atmospheric hazards — oxygen deficiency, toxic gases, or flammable vapours", "Flooding risk from groundwater"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["Explosive material", "Oxidizing substance", "Acute toxicity — lethal or severely harmful at low exposure", "Environmental hazard"],
    correctIndex: 2,
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-a-tools", topicLabel: "MWA A — Tools and Equipment",
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-a-organization", topicLabel: "MWA A — Work Organization",
    question: "On electrical drawings, a dashed line between two devices typically represents:",
    options: ["A 120V power circuit", "A conduit run that is underground or concealed", "A control wiring or signal circuit connection", "A future installation not yet approved"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["Shop drawing", "Single-line diagram", "As-built (record) drawing", "Schematic diagram"],
    correctIndex: 2,
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-a-support", topicLabel: "MWA A — Support Components",
    question: "What is the maximum support spacing for EMT run horizontally in a commercial building per the CEC?",
    options: ["1.0 m", "1.5 m", "3.0 m", "No maximum if secured at each end"],
    correctIndex: 2,
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-a-commissioning", topicLabel: "MWA A — Commissioning",
  ...
  // ══════════════════════════════════════════════════════════
  // MWA B — GENERATING, DISTRIBUTION & SERVICE SYSTEMS  (q25–76)
  // ══════════════════════════════════════════════════════════

  {
    tradeSlug: "construction-electrician", topicId: "mwa-b-services", topicLabel: "MWA B — Services and Metering",
  ...
  },
  {
    ...
    options: ["Phase A", "Phase B — the high (wild) leg", "Phase C", "The neutral conductor"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["3.0 m", "4.0 m", "4.9 m", "5.5 m"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["Always exactly one", "A maximum of six grouped at one location", "Unlimited, distributed throughout", "Two — one for each half of the service"],
    correctIndex: 1,
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-b-grounding", topicLabel: "MWA B — Grounding and Bonding",
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-b-protection", topicLabel: "MWA B — Protection and Distribution",
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-b-transformers", topicLabel: "MWA B — Transformers",
  ...
  },
  {
    ...
    options: ["24V, 10:1 step-down", "2400V, 1:10 step-up", "24V, 1:10", "240V, 1:1"],
    correctIndex: 0,
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-b-renewable", topicLabel: "MWA B — Renewable Energy",
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-b-highvoltage", topicLabel: "MWA B — High Voltage",
  ...
  },
  {
    ...
    options: ["Air", "Mineral oil", "Dry (cast resin)", "SF₆ gas"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: [
      "Instantaneous overcurrent", "Time-overcurrent (inverse-time overcurrent)", "Differential protection", "Under-voltage relay"],
    correctIndex: 1,
  ...
  // ══════════════════════════════════════════════════════════
  // MWA C — WIRING SYSTEMS  (q77–116, continued in Part 2 to q136)
  // ══════════════════════════════════════════════════════════

  {
    tradeSlug: "construction-electrician", topicId: "mwa-c-conductors", topicLabel: "MWA C — Conductors",
  ...
  },
  {
    ...
    options: ["4.9V (2.1%)", "7.5V (3.1%)", "9.9V (4.1%)", "14.8V (6.2%)"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["8.1V (1.3%)", "14.1V (2.4%)", "16.2V (2.7%)", "22.9V (3.8%)"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["White or grey", "Green or bare (uninsulated)", "Red", "Orange"],
    correctIndex: 1,
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-c-raceways", topicLabel: "MWA C — Raceways",
  ...
  },
  {
    ...
    options: ["0.9 m", "1.8 m", "3.0 m", "No maximum"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["300 mm (12 in)", "450 mm (18 in)", "600 mm (24 in)", "750 mm (30 in)"],
    correctIndex: 2,
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-c-branch", topicLabel: "MWA C — Branch Circuits and Devices",
  ...
  },
  {
    ...
    options: ["UL Listed", "CSA Approved", "IC-Rated (Insulation Contact Rated)", "Wet Location Listed"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["6 receptacles", "8 receptacles", "12 receptacles", "No limit specified — based on calculated load"],
    correctIndex: 3,
  ...
  // ══════════════════════════════════════════════════════════
  // MWA C — WIRING SYSTEMS  (continued, q117–136)
  // ══════════════════════════════════════════════════════════

  {
    tradeSlug: "construction-electrician", topicId: "mwa-c-hvac", topicLabel: "MWA C — HVAC Systems",
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-c-heating", topicLabel: "MWA C — Electric Heating",
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-c-cathodic", topicLabel: "MWA C — Cathodic Protection",
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-c-wiring-methods", topicLabel: "MWA C — Wiring Methods",
  ...
  // ══════════════════════════════════════════════════════════
  // MWA D — MOTORS AND CONTROL SYSTEMS  (q137–172, 36 questions)
  // ══════════════════════════════════════════════════════════

  {
    tradeSlug: "construction-electrician", topicId: "mwa-d-motors", topicLabel: "MWA D — Motors",
  ...
  },
  {
    ...
    options: ["10 HP", "15 HP", "20 HP", "25 HP"],
    correctIndex: 1,
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-d-starters", topicLabel: "MWA D — Motor Starters",
  ...
  },
  {
    ...
    options: ["18.0A (100% FLA)", "19.8A (110% FLA)", "23.4A (130% FLA)", "27.0A (150% FLA)"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["125% of motor FLA", "150% of motor FLA", "300% of motor FLA", "400% of motor FLA"],
    correctIndex: 2,
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-d-drives", topicLabel: "MWA D — Variable Frequency Drives",
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-d-controls", topicLabel: "MWA D — Control Systems",
  ...
  // ══════════════════════════════════════════════════════════
  // MWA E — SIGNALLING AND COMMUNICATION SYSTEMS  (q173–200, 28 questions)
  // ══════════════════════════════════════════════════════════

  {
    tradeSlug: "construction-electrician", topicId: "mwa-e-firealarm", topicLabel: "MWA E — Fire Alarm Systems",
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-e-security", topicLabel: "MWA E — Security Systems",
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-e-vdv", topicLabel: "MWA E — VDV and Communication Systems",
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-e-bas", topicLabel: "MWA E — Building Automation Systems",
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-e-security", topicLabel: "MWA E — Security and Access Control",
  ...
  {
    tradeSlug: "construction-electrician", topicId: "mwa-e-bas", topicLabel: "MWA E — Integrated Systems",
  ...
  {
    tradeSlug: "hairstylist", topicId: "A", topicLabel: "MWA A — Safety and Hygiene",
    ...
    options: ["Apply an antiseptic and proceed with the service", "Refer the client to a physician and decline the service until cleared", "Cover the affected area with a towel and continue", "Perform the service using extra protective gloves only"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Sterilization using an autoclave", "Disinfection with an approved hospital-grade disinfectant", "Sanitation by wiping with a damp cloth", "Sanitizing with soap and water only"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Continue working while wearing double gloves", "Switch to a different brand of the same product", "Consult a physician and report the reaction to the employer — use barrier protection and avoid the irritant", "Wash hands frequently and reduce exposure time"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["Proceed — a mild reaction means the client can tolerate the colour", "Reduce the developer volume and proceed", "Do not perform the colour service and inform the client of the reaction", "Rinse the test site and perform the service within 30 minutes"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["Wrap in tissue and place in the regular waste bin", "Place directly into the sharps (biohazard) container without resheathing", "Resheath by hand and place in the regular bin", "Flush down the sink drain"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Touching a contaminated surface and then touching the face", "Breathing in airborne fungal spores from infected hair clippings on the floor", "Direct contact with an open lesion from tinea capitis on a client's scalp", "Using tools from a shared drawer without disinfecting"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["1–2 minutes", "5–10 minutes", "At least 10 minutes (or per manufacturer's contact time instructions)", "30 seconds is sufficient for high-grade disinfectants"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["To track product inventory and expiry dates for salon retail products", "To regulate the pricing of salon chemical services", "To ensure workers are informed of hazards associated with chemical products through Safety Data Sheets, labels, and training", "To certify that salon products are approved for professional use only"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["Take over-the-counter pain medication and continue working", "Ensure adequate ventilation in the salon — open windows and use exhaust fans during chemical services", "Work faster to reduce exposure time", "Switch from powder bleach to cream bleach only"],
    correctIndex: 1,
  ...
  // ── A-2: Tools and Equipment (q10–14) ─────────────────────
  {
    tradeSlug: "hairstylist", topicId: "A", topicLabel: "MWA A — Tools and Equipment",
    ...
    options: ["Straight blunt scissors", "Thinning (texturizing) scissors with one serrated blade", "Curved scissors", "Offset-handle scissors"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Sharpen on a household whetstone to maintain the original angle", "Have scissors sharpened by a professional scissor technician who preserves the original bevel and convex edge", "Use the built-in sharpener inside the shear case", "Rub the blades together briefly to realign the edge"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Thinning scissors", "A razor (feather/shaper)", "Sharp straight scissors (7–8 inch)", "Electric clippers with a #2 guard"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["A boar-bristle brush cuts hair faster during blow-drying", "Boar bristles distribute the hair's natural oils from root to ends, add shine, and are gentler — best for fine or fragile hair; nylon bristles detangle more effectively and are more aggressive", "Boar-bristle brushes are only used for beard grooming", "Nylon brushes are always preferred because they withstand high heat better"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Adjusts the blade speed for different hair textures", "Changes the guard size from short to long", "Opens and closes the blade to adjust the cutting length between guard sizes, allowing blending and graduated fades", "Activates the detachable blade release mechanism"],
    correctIndex: 2,
  ...
  // ── A-3: Prepares for Client Services (q15–18) ────────────
  {
    tradeSlug: "hairstylist", topicId: "A", topicLabel: "MWA A — Client Consultation",
    ...
    options: ["Tell the client what would suit them best based on visual assessment only", "Ask open-ended questions, listen actively, and use visual references (photos, style books) to confirm mutual understanding", "Show the client the same style that is trending currently without discussion", "Begin the service and adjust based on client feedback mid-way through"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["The client's credit card information for convenience", "Services performed, products used and formulas applied, results achieved, any contraindications noted, and the client's preferences and reactions", "Only the price charged for the service", "The hairstylist's personal opinion of the client's hair condition"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Apply all products uniformly from root to end using the same formula and timing", "Ignore the variation — all professional products are designed to work on any hair condition", "Plan product application, processing times, and formulas to account for each zone's different porosity and response to chemicals", "Always start services at the ends where the most damage is present"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["Round face shape", "Oval face shape", "Oblong (long/rectangular) face shape", "Heart face shape"],
    correctIndex: 2,
  ...
  // ── A-4: Communication and Mentoring (q19–23) ─────────────
  {
    tradeSlug: "hairstylist", topicId: "A", topicLabel: "MWA A — Communication",
    ...
    options: ["Take over all the junior's client consultations until they improve", "Observe the junior in action, provide specific feedback using examples, and role-model a thorough consultation technique", "Warn the junior that they will be dismissed if they do not improve", "Assign extra reading on consultation theory only"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Blame the client for not being clear during the consultation", "Apologize and immediately offer a refund without any discussion", "Acknowledge the client's feelings, review what was discussed during consultation, and collaboratively explore options to address their concerns", "Explain technically why the cut is correct and tell the client they are wrong"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["A product brochure from the manufacturer describing recommended uses", "A legal document listing hazard information, safe handling, emergency procedures, and first aid for a hazardous product — accessed before working with an unfamiliar chemical or in response to an accident or spill", "A government tax document for chemical product purchases", "A client consent form for chemical services"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Document the disclosure and proceed with a lower-strength colour formula", "Document the allergy on the client record card, decline the service, and recommend the client consult a dermatologist before any colour service", "Perform a patch test and if it is negative, proceed immediately", "Offer a semi-permanent colour instead since it is 'gentler'"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Discussing interesting client stories with other stylists during quiet periods", "Sharing client before-and-after photos on social media without written consent", "Keeping all client information, service history, and personal disclosures private and not sharing with anyone except for legitimate professional need and with consent", "Posting client transformation photos with faces blurred — no consent needed"],
    correctIndex: 2,
  ...
  // ══════════════════════════════════════════════════════════
  // MWA B — HAIR AND SCALP CARE  (q24–41)
  // ══════════════════════════════════════════════════════════

  // ── B-5: Analyzes Hair and Scalp Conditions (q24–33) ──────
  {
    tradeSlug: "hairstylist", topicId: "B", topicLabel: "MWA B — Hair and Scalp Analysis",
    ...
    options: ["High elasticity — ideal for chemical services", "Low elasticity caused by internal cortex damage — the hair may not be suitable for chemical services", "High porosity — the hair absorbs water quickly", "Normal hair — stretching when wet is expected"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["By pulling a strand and measuring the force required to break it", "By sliding fingers from the ends toward the roots along a dry strand — rough, catching texture indicates high porosity; smooth indicates low porosity", "By measuring the strand diameter with a calliper", "By checking whether the hair floats or sinks in a bowl of water"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Density refers to the diameter of individual hair strands — fine hair has low density", "Density refers to the number of hairs per square centimetre on the scalp — high density means more hair follicles, requiring larger sections and stronger product formulations for even penetration", "Density is synonymous with elasticity", "Density describes how heavy the hair feels when freshly washed"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Tinea capitis (ringworm of the scalp)", "Seborrhoeic dermatitis (dandruff)", "Psoriasis", "Alopecia areata"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Alopecia areata — proceed with the service using gentle products", "Tinea capitis (ringworm) — refer the client to a physician; do not perform any service", "Trichotillomania — advise the client to stop pulling their hair", "Traction alopecia — recommend looser hairstyles and proceed with a conditioning treatment"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["The hair will process slowly and require a stronger waving solution", "The hair will process quickly and require a milder waving solution with careful monitoring to avoid over-processing", "Porosity has no effect on permanent wave processing time", "Fine hair cannot be permed under any circumstances"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Collagen", "Melanin", "Keratin", "Elastin"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["Seborrhoeic dermatitis", "Psoriasis", "Contact dermatitis", "Ringworm"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["To determine the hair's colour level and tone", "To determine if the internal cortex bonds are intact enough to withstand the chemical process without causing breakage", "To measure the hair's natural oil content", "To assess the diameter of the individual hair shaft"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Androgenetic alopecia (male/female pattern baldness)", "Pediculosis capitis (head lice)", "Alopecia areata", "Seborrhoeic dermatitis"],
    correctIndex: 1,
  ...
  // ── B-6: Shampoos and Conditions (q34–41) ─────────────────
  {
    tradeSlug: "hairstylist", topicId: "B", topicLabel: "MWA B — Shampooing and Conditioning",
    question: "What pH range is typical for most professional shampoos, and why is this range important?",
    options: ["pH 1–3 (strongly acidic) — to remove mineral buildup", "pH 4.5–5.5 (slightly acidic) — close to the hair's natural pH to maintain the cuticle in a closed, smooth state", "pH 7 (neutral) — to avoid any reaction with the hair", "pH 8–10 (alkaline) — to open the cuticle for deep cleansing"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Moisturizing (emollient) shampoo", "Clarifying or deep-cleansing shampoo", "Dry shampoo", "Colour-safe (sulphate-free) shampoo"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["It makes the product harder to distribute evenly", "Abrasion creates micro-lesions in the scalp skin, allowing the chemical to penetrate more deeply and cause chemical burns", "It wastes the hairstylist's time during the service", "Scratching causes dandruff, which interferes with processing"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["They are identical — just different marketing terms", "A rinse-out conditioner is applied and removed immediately after shampooing to smooth the cuticle; a deep conditioner (mask or treatment) uses heat and longer processing time to penetrate the cortex and rebuild internal protein or moisture bonds", "Rinse-out conditioners contain protein; deep conditioners contain moisture only", "Deep conditioners are only for dry hair; rinse-out conditioners are for all hair types"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Hair is limp and stretches excessively without returning", "Hair feels stiff, rigid, and lacks elasticity — stretches only slightly then breaks, and feels 'straw-like'", "Hair appears frizzy and has a rough texture with a spongy feel when wet", "Hair is oily at the roots and dry at the ends only"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["It adds protein to strengthen the hair before chemical services", "It removes mineral deposits (hard water calcium and magnesium ions) from the hair, restoring conductivity for chemical services and eliminating dull, rough texture", "It permanently straightens hair using chelating agents", "It removes artificial hair colour from the hair shaft"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Cold water — to stimulate the scalp and close the cuticle", "Hot water (above 50°C) — to open the cuticle for thorough cleansing", "Warm/comfortably warm water — comfortable to the client, effective for product removal without scalding or causing discomfort", "Room temperature water only — to prevent over-stimulation of sebaceous glands"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["A heavy, rich moisturising mask applied from roots to ends", "A volumizing leave-in conditioner or lightweight spray conditioner applied to ends only — avoiding the roots", "A hot oil treatment applied to the scalp", "The same deep conditioning mask used for coarse hair"],
    correctIndex: 1,
  ...
  // ══════════════════════════════════════════════════════════
  // MWA C — CUTS HAIR  (q42–81)
  // ══════════════════════════════════════════════════════════

  // ── C-7: Cuts Diverse Textures (q42–74) ───────────────────
  {
    tradeSlug: "hairstylist", topicId: "C", topicLabel: "MWA C — Haircutting",
    question: "What is the result of cutting hair at 0° elevation (no elevation)?",
    options: ["A heavily layered look with lots of movement", "A one-length, solid form — all hair falls to the same perimeter line when the hair is combed down", "A short-to-long graduated effect", "Maximum volume at the top with minimal length at the perimeter"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["A one-length (solid) cut", "A uniform layer cut — all hair is the same length regardless of section location, creating maximum volume and movement", "A heavily graduated (stacked) bob", "A disconnected undercut"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Hair is the same length from nape to crown", "Hair gets progressively longer from nape to crown, creating a stacked, full appearance at the back", "Hair gets shorter from nape to crown", "Hair is cut in a disconnected pattern with no consistent length change"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["To keep the guide stationary and cut all sections to it", "To move the guide with each section so that each subsequent section uses the previously cut hair as its guide — used to create layers in long or uniform layer cuts", "To cut hair without using any guide for free-form results", "To establish a fixed perimeter length only"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["It makes the cut perfectly even with no weight variation", "Over-directing hair away from the growth creates longer hair at the point of growth (weight) and shorter hair at the point of pull, building weight in one area — used intentionally for asymmetric or disconnected designs", "It creates maximum elevation and removes all weight", "It results in the same effect as 0° elevation"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["To create a blunt, precise perimeter line", "To remove bulk from the interior of the section without affecting the perimeter length", "To soften and texturize the perimeter line, removing the harsh edge from a blunt cut and creating movement", "To create dramatic, chiselled disconnection in the cut"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["Cut the hair very short to draw attention away from the nose", "Add volume and width at the sides of the face to balance the feature and draw the eye outward from the central focal point", "Recommend a centre-parted style with flat hair close to the head to frame the face", "Add height at the crown to elongate the face"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Razors and scissors produce identical results on fine hair", "A razor cut produces softer, more diffused ends with natural movement — best used on damp fine hair; scissors create more precise, blunt ends; razors can cause thin fine hair to look even thinner if overused", "A razor always creates more volume than scissors", "Scissors cannot be used on fine straight hair"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Point cutting", "Blunt cutting", "Slide cutting (effilating)", "Channelling"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["Cutting with only one guard size throughout the fade", "Using a rocking motion with the clipper — flicking the wrist away from the head as the clipper moves upward, reducing the cutting depth gradually at the blend line", "Cutting all hair at the same length and then finger-combing", "Applying heat to the hair before clippering to make it stand up"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["A guide is an optional step that experienced stylists skip", "A guide is the initial section cut to an established length that all subsequent sections will be measured against — it ensures consistency and accuracy throughout the haircut", "A guide is the final perimeter cut performed at the end of the haircut", "A guide is a reference photo used during the consultation only"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Dry cutting is always faster and produces the same results", "Cutting curly hair dry allows the stylist to see and work with the natural curl pattern and shrinkage — wet curly hair stretches and, when cut, springs back shorter than expected, leading to uneven results", "Dry cutting is required because curly hair damages scissors when wet", "Dry cutting prevents the curl from going straight during blow-drying"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["To divide the head into sections for applying foil highlights", "To divide the head into four equal sections (front, back, left, right) using a centre parting and ear-to-ear parting, providing organised working zones for systematic cutting", "To identify the four skull bones relevant to cutting graduation", "To create four separate elevation lines for extreme layering"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["0° elevation, blunt perimeter cut with no interior layering", "45° elevation throughout for heavy graduation at the back", "90° elevation from the head form with a travelling guide, working from the perimeter upward", "180° elevation — holding hair straight up and cutting horizontally"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["Cut against the direction of the cowlick for a clean result", "Ignore the cowlick — products will control it after the cut", "Identify the direction the cowlick grows and cut with its natural growth direction, leaving enough weight to fall into place rather than fighting it", "Cut the cowlick section very short so it lies flat"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["When the comb disconnects from the hair during cutting", "An intentional design element where two adjacent sections are cut at significantly different lengths with no blending between them, creating a dramatic contrast", "When the hair is too tangled to cut smoothly", "A sectioning error that results in uneven layers"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["A bob that is shorter at the back and longer in the front, angling from a shorter back nape to longer front sections — creating an A-shape silhouette", "A bob that is the same length all around, creating a square A-frame silhouette", "A bob with heavy fringe (bangs) that frames the face like the letter A", "A bob that is longer at the back and shorter at the front"],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ["The comb holds the hair in place while the scissors slide over it, cutting only the hair projecting above the spine of the comb — creating seamless graduation in short haircuts without using clippers", "The comb is used only to detangle the hair before cutting begins", "The comb prevents the scissors from slipping during the cut", "The comb measures the exact length of hair being cut"],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ["The colour of the hair", "The diameter of the hair shaft only", "The presence of natural curl, wave, or cowlick in the fringe area — curly hair will spring up significantly shorter when dry; straight hair cuts more predictably", "The sharpness of the scissors"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["It is the prominent bone of the forehead that affects fringe placement", "It is the protruding bone at the back of the skull — the point above which hair tends to curve away from the head, marking a key reference point for weight line placement in bobs and graduated cuts", "It is the bone that forms the cheekbone, relevant to face-framing sections", "It is the bone behind the ear, which affects the shape of the sideburn area"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Razor cut the entire perimeter", "Use thinning scissors in the interior of large sections at the mid-lengths and ends, working with vertical or diagonal strokes inside the section", "Cut 2 inches off the perimeter to remove weight at the ends", "Use a flat iron to compress the hair rather than cutting"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Measuring the hair with a ruler to verify exact centimetre lengths", "Cross-checking the cut by picking up sections from opposite sides of the head and comparing them visually and between the fingers to verify balance and symmetry", "Re-cutting all sections to make them slightly shorter", "Applying product to check how the style will look when finished"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["All hair textures produce the same visual result from a blunt cut", "Straight hair produces a clean, precise blunt line; wavy hair produces a softer, slightly irregular edge; curly hair appears shorter and can look diffuse rather than blunt due to spring and curl formation", "Curly hair produces the cleanest blunt line because curls align neatly", "Wavy hair should never be cut blunt — it always needs layering"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Maximum tension — pull the hair as tightly as possible for the most accurate cut", "No tension — allow the hair to hang freely", "Even, consistent, moderate tension — enough to keep the section controlled and straight for accurate cutting without stretching or distorting the natural fall", "Different tension for each section based on feel"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["Partings should be taken diagonally to create a natural, asymmetric result", "Partings should be taken horizontally (parallel to the floor), working from the nape upward, to ensure each row is cut precisely to the guide and the perimeter remains level", "Partings should radiate from the crown downward", "Random partings create the best one-length result"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["The lower section is tapered very close with clippers, while the upper section retains length and is NOT blended into the shorter section — the contrast is intentional", "The clippers are disconnected (turned off) for the upper section", "The perimeter line is cut at an angle to create a disconnected shape", "The undercut is performed with scissors only, not clippers"],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ["Cutting with dry, unsharpened scissors to create a natural frayed edge", "Cutting the hair in its natural dry state, allowing the stylist to work with the curl's actual pattern, spring, and distribution", "Cutting hair after applying dry shampoo to add grip", "Cutting with a dryer blowing on the hair during the service"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["The clipper must always be parallel to the floor regardless of the head position", "The clipper is held parallel to the comb and the comb angle controls the graduation — tilting the comb closer to the head as it moves upward creates a tighter blend; holding it farther away creates a looser, longer blend", "The clipper angle determines the width of each hair section", "The clipper angle has no effect — only the guard size matters"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Graduation and layering are identical terms for the same technique", "Layers are created by elevating hair above 90° and cutting; graduation uses 90° elevation only", "Graduation (45° elevation) builds weight at the perimeter with progressively longer hair toward the interior; uniform layers (90°) remove weight throughout and create movement without building a perimeter weight line", "Graduation always removes more hair than layering"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["Add maximum volume at the sides through heavy graduation and layers at the cheekbones", "Create height at the crown and minimize width at the sides — using lengthening vertical layers and avoiding excessive side volume", "Cut hair very short and uniform across the head", "Create a wide, horizontal fringe that emphasises the width of the forehead"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["To separate the colour-treated hair from the natural-growth hair", "To divide the top (front) sections from the back sections, creating a systematic working order and preventing over-direction of sections across the divide", "To identify the position of the occipital bone", "To determine the client's natural part line"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["This area should always be left uncut to avoid damaging the ear", "The hairstylist must identify and work with the natural growth direction around the ear (which often grows forward or in multiple directions), fold the ear down for safety, and use precision cutting or a detail clipper for clean outlining", "Always use a razor in this area for a smooth result", "Cut this area first before any other sectioning for consistency"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["The crown — where the fade finishes at the longest section", "The blend line — the transition zone where the very short clipped area meets the longer hair above, which must be feathered seamlessly with no visible demarcation", "The fringe area — where the hair sits forward at the front", "The nape — which is always blended the same way in every fade"],
    correctIndex: 1,
  ...
  // ── C-8: Cuts Facial and Nape Hair (q75–81) ───────────────
  {
    tradeSlug: "hairstylist", topicId: "C", topicLabel: "MWA C — Facial and Nape Hair",
    question: "What is the correct technique for outlining a beard using a straight razor?",
    options: ["Apply lather to the entire beard area and remove all hair with the razor in a single session", "Comb and trim the beard with scissors first to establish shape, then use the razor to define crisp, clean boundary lines (neckline, cheek lines) in the direction of hair growth with a stretched, taut skin", "Use clippers only — razors are not used for beard outlining", "Apply no product and use the razor dry for the most precise line"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Keep the beard the same length at the chin and jaw line to emphasise the square shape", "Trim the beard slightly shorter at the jawline angles (corners) and leave more length and fullness at the chin — creating a more rounded or oval beard silhouette that softens the square jaw", "Remove all beard hair on the cheeks and keep only chin hair", "Cut the beard very short and uniform to emphasize facial features"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["The neckline should always be cut as high as possible to look professional", "The neckline should be placed at the two-finger width above the natural hairline, using a small 'V' or 'U' shape following the client's natural neckline growth", "The neckline should always follow a perfectly straight horizontal line", "Cut the neckline to the lowest natural hair growth regardless of shape"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["They are the same — just regional terminology differences", "A blocked neckline cuts a straight horizontal line across the natural hairline; a tapered neckline uses the clippers with a taper lever to fade the natural hairline into the skin gradually without a defined edge", "A blocked neckline is for women; a tapered neckline is for men", "A tapered neckline is more formal; a blocked neckline is casual"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Use a straight razor to outline and remove stray hairs precisely", "Comb the brow hairs upward with a small comb and trim any hairs that extend beyond the natural brow line using small scissors — wax or tweeze stray hairs outside the brow shape", "Use thinning scissors throughout the entire eyebrow to reduce density", "Apply bleach to lighten the brow colour before trimming"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Cut horizontally across the entire moustache at once for speed", "Comb the moustache hair downward over the upper lip, trim only the hair extending below the upper lip line using scissors, then comb it to its natural position to check the shape", "Use clippers with no guard directly on the moustache area", "Have the client smile widely then cut — this shows the natural shape"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Speed — the faster the stroke, the cleaner the shave", "The risk of cutting the skin — managed by holding the razor at the correct angle (30–45°), using short, controlled strokes, keeping the skin taut with the non-dominant hand, and maintaining a sharp, clean blade", "Razor temperature — the blade must be warmed before use", "Applying too much shave cream, which obscures the hairline"],
    correctIndex: 1,
  ...
  // ══════════════════════════════════════════════════════════
  // MWA D — STYLES HAIR  (q82–107, 26 questions)
  // ══════════════════════════════════════════════════════════

  // ── D-9: Prepares and Styles Wet Hair (q82–94) ────────────
  {
    tradeSlug: "hairstylist", topicId: "D", topicLabel: "MWA D — Wet Hair Styling",
    question: "What is the purpose of a setting lotion (wet setting foam or liquid) applied before roller setting?",
    options: ["To chemically straighten the hair for a smooth set", "To provide temporary hold, body, and help the set last longer by stiffening the temporary hydrogen bonds formed as the hair dries around the roller", "To condition and moisturise the hair while it sets", "To replace the need for a neutralizer after roller setting"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Large rollers (2 inch diameter or more)", "Small rollers (3/4 inch or less diameter) — smaller roller = tighter curl", "Magnetic rollers produce the tightest curls regardless of size", "All roller sizes produce the same curl tightness — only the product formula affects curl size"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["The base section can be any size — it does not affect the result", "The base section should not be wider than the roller and should be no longer than the diameter of the roller — ensuring the hair wraps smoothly and the roller sits on its own base for maximum volume at the root", "The base section must always be exactly twice the roller diameter", "No base sectioning is needed — the hair is simply wound around each roller randomly"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["All rollers placed in the same direction using a brick-lay (offset) pattern", "All rollers placed in the same direction top to bottom", "Alternating rollers placed toward the face and away from the face in each row — creating directional variation", "Spiral wrapping vertically using pin curls only"],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ["A modern wave created with a curling iron on dry hair — works best on long, coarse hair", "A sculptural pattern of alternating ridges and waves shaped by the fingers, comb, and waving lotion into damp hair — works best on short to medium-length, fine to medium straight hair", "A braiding technique that creates a wave pattern — works best on thick coily hair", "A blow-dry technique for creating beach waves — works best on any length"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["A diffuser concentrates airflow into a single stream for faster drying", "A diffuser disperses airflow over a wide area, reducing velocity and turbulence — preserving the curl or wave pattern, enhancing definition, and minimizing frizz", "A diffuser heats the air to a higher temperature for faster setting", "A diffuser is used only with straightening techniques"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Dry ends first, then mid-lengths, then roots in any direction", "Direct the airflow from the nozzle downward along the cuticle and dry from roots to ends — at the root, use the round brush to lift and dry the hair against its natural fall direction, then direct downward for cuticle smoothing at the ends", "Apply maximum heat to the lengths first and finish by blasting the roots with cold air", "Flip the head upside down, dry roughly without direction, then flip upright and apply product"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Wrapping the hair tightly in a towel and squeezing — for all hair types", "Gathering sections of hair and squeezing upward toward the scalp (scrunching) while diffusing — for wavy and curly hair to encourage and define the natural curl pattern without frizz", "Pulling the hair flat against the head and pressing with a brush — for fine, straight hair", "Combing the hair upward with a wide-tooth comb while drying — for coarse, thick hair"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["To reduce heat output and prevent damage to fine hair", "To diffuse airflow for gentle drying of curly hair", "To concentrate and direct airflow into a narrow stream — allowing precision control of direction for smooth blow-drying and directing air down the cuticle for shine", "To increase the volume of air output for faster drying of thick hair"],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["Apply mousse directly to the scalp and massage in for maximum root volume", "Dispense a golf-ball to apple-sized amount of mousse into the palm, emulsify between both palms, and work through the hair from roots to ends — scrunching into the hair for curly styles or combing through for smooth styles", "Apply mousse only to the hair ends to avoid weighing down the roots", "Apply mousse to dry hair at the end of the style for extra hold"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["To detangle the hair before shampooing", "To create a smooth, voluminous blow-dry — the barrel adds curl and direction while the bristles smooth the cuticle; used to create volume, bend, and body in the hair as it dries", "To backcomb the hair for added height in updos", "To distribute product from roots to ends evenly before a roller set"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Removing rollers early has no effect on the finished result", "If the hair is removed before fully dry, the hydrogen bonds — which form as the hair dries in the set shape — are not fully established, and the set will not hold, leaving limp, barely defined results", "Removing rollers before drying damages the scalp", "Partial drying creates more defined curls than complete drying"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["A curl created by wrapping hair around a heated curling iron barrel", "A small curl formed by winding a section of wet hair in a circular pattern and securing with a clip or pin — the diameter of the circle formed by the curl determines its size when dry", "A curl created by backcombing the hair and pinning it at the root", "A curl formed by braiding wet hair and unravelling after drying"],
    correctIndex: 1,
  ...
  // ── D-10: Styles and Finishes Dry Hair (q95–107) ──────────
  {
    tradeSlug: "hairstylist", topicId: "D", topicLabel: "MWA D — Dry Hair Styling",
    question: "What is the correct temperature range for a flat iron used on fine, chemically treated hair?",
    options: ["230–260°C (450–500°F) — maximum heat for fastest results", "120–160°C (250–325°F) — lower temperatures for fine or damaged hair to prevent heat damage", "180°C (350°F) is appropriate for all hair types and textures", "The temperature setting is irrelevant as long as the passes are quick"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Wrap all sections in the same direction (all toward or all away from face) for the entire head", "Alternate the wrapping direction on each section across the head", "Wrap only the ends of each section, leaving the mid-lengths straight", "Apply maximum tension to each section and hold for 60 seconds per curl regardless of hair texture or condition"],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ["Heat protectants chemically straighten the hair, making thermal tools more effective", "Heat protectants coat the hair shaft with a film of silicone or polymer that reduces direct heat transfer to the cortex, reducing the risk of protein denaturation and moisture loss", "Heat protectants allow the use of higher temperatures without any risk of damage", "Heat protectants add fragrance to the hair during thermal styling"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Combing hair downward from ends to roots — used to remove tangles", "Combing or raking small amounts of hair backward from the ends toward the root, creating a compact, tangled mass of hair at the root area — used to create volume, height, and support for updos and elevated styles", "Combing hair in an upward direction using a wide-tooth comb to add volume", "Applying hairspray while combing — a combined product-and-technique for hold"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["All hairsprays provide the same hold — differences are only in fragrance", "Hairspray creates a film over the finished style to maintain shape; light-hold sprays create a flexible, touchable film suitable for everyday styles; maximum-hold sprays create a rigid, stiff film for styles requiring maximum longevity such as updos or theatrical work", "Hairspray conditions the hair while providing hold", "Hairspray should be applied before all other styling products as a base coat"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Dry shampoo, thinning scissors, and a wide-tooth comb", "Smoothing serum or anti-frizz cream (applied to damp hair before drying), a bristle brush for final smoothing, bobby pins and hair pins for structure, and a strong-hold hairspray for finishing", "Maximum-hold gel applied to wet hair, followed by air-drying and pinning", "Only mousse and a blow dryer — no pins or spray needed"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["They are interchangeable — both work identically on all hair types", "Pomade is a heavy, oil- or wax-based product that provides strong hold, definition, and shine with a wet or polished finish — best for short, defined styles; mousse is a lightweight foam applied to wet hair to provide flexible hold, body, and support for volume-based or curl-enhancing styles", "Mousse is only for curly hair; pomade is only for straight hair", "Pomade opens the cuticle; mousse closes it"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Use maximum heat and fast passes, repeating until straight", "Ensure the hair is completely dry, section thinly (no thicker than the width of the flat iron plate), apply heat protectant, and glide the iron slowly and steadily in one smooth pass from root to end — maintaining consistent tension and angle", "Use the flat iron on wet hair to save time drying first", "Apply no product and use maximum tension while ironing"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["They are the same braid — 'French braid' is just a regional name for a three-strand braid", "A three-strand braid is formed entirely from three sections hanging freely from a fixed starting point; a French braid incorporates additional hair from the scalp into each crossing motion, anchoring the braid to the head and creating an on-the-scalp, seamlessly integrated effect", "French braids use four strands; three-strand braids use three", "A three-strand braid is tighter than a French braid"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Begin pinning immediately to save time", "Complete a thorough consultation including viewing inspiration photos, determining the desired style, assessing hair texture and length for feasibility, discussing the timeline and scheduling a trial run", "Apply maximum-hold gel to the hair before even discussing the style", "Trim the hair on the wedding day to freshen the cut before styling"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["It cleanses the hair as effectively as a water-and-shampoo wash", "It absorbs excess sebum (scalp oil) at the root area, refreshes the hair between washes, adds texture and grip for styling, and extends the life of a style — it does not replace a proper shampoo", "It conditions the ends of dry hair to prevent breakage", "It adds shine to the hair when sprayed on the mid-lengths and ends"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Apply heavy serum to roots and ends, blow-dry flat, then backcomb aggressively", "Apply volumizing mousse to damp roots, blow-dry using a round brush with lift at the roots, use a medium-hold spray, and backcomb lightly at the crown for additional height", "Air-dry and apply maximum-hold gel while wet for long-lasting volume", "Apply pomade to dry hair and backcomb heavily — no blow-dry needed"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["That the iron is at maximum temperature to process the protectant", "That the hair is completely dry — applying a flat iron to product-applied damp hair creates steam within the cortex, causing severe internal damage called 'bubble hair'", "That no protectant is used, as it reduces the iron's effectiveness", "That the product is oil-based for maximum heat resistance"],
    correctIndex: 1,
  ...
  {
    tradeSlug:"hairstylist",topicId:"E",topicLabel:"MWA E — Permanent Waving",
  ...
  {
    tradeSlug:"hairstylist",topicId:"E",topicLabel:"MWA E — Chemical Relaxers",
  ...
  {
    tradeSlug:"hairstylist",topicId:"F",topicLabel:"MWA F — Hair Colouring",
  ...
  {
    tradeSlug:"hairstylist",topicId:"F",topicLabel:"MWA F — Lightening",
  ...
  {
    tradeSlug:"hairstylist",topicId:"F",topicLabel:"MWA F — Colour Correction",
  ...
  {
    tradeSlug:"hairstylist",topicId:"G",topicLabel:"MWA G — Hair Extensions",
  ...
  {
    tradeSlug:"hairstylist",topicId:"G",topicLabel:"MWA G — Specialized Services",
  ...
  {
    tradeSlug:"hairstylist",topicId:"mwa-h-frontdesk",topicLabel:"MWA H — Front Desk and Salon Operations",
  ...
  {
    tradeSlug:"hairstylist",topicId:"H",topicLabel:"MWA H — Business Fundamentals",
